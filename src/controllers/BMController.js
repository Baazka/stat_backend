  ...
  async BM3List(req, res) {
    try {
      ...
      RIGHT JOIN (
        ...
        RFT.FORM_TYPE_ID,
        RFT.FORM_TYPE_NAME AUDIT_TYPE,
        NVL(DECODE(FA.PERIOD_ID, 3, EN.PERIOD3_NAME, 4, EN.PERIOD4_NAME),AE.ENT_NAME) ENT_NAME,
        AO.ORG_REGISTER_NO,
        RBT.BUDGET_TYPE_ID,
        RBT.BUDGET_SHORT_NAME,
        RD.DEPARTMENT_NAME AS AUDIT_ORG_CHECK_NAME,
        RD1.DEPARTMENT_NAME AS DEPARTMENT_NAME,
        A.IS_ZALRUULAH,
        A.IS_ZALRUULAH_NAME,
        ...
        --DUGNELT ALDAA ZURCHIL
        INNER JOIN (--tuuwer 52
        ...
        LEFT JOIN FAS_ADMIN.REF_DOCUMENT_INDICATOR_VALUE V5 ON A.IS_ZALRUULAH = V5.ID
        WHERE A.IS_ACTIVE = 1 AND A.IS_ERROR_CONFLICT = 285) A ON FA.ID = A.FAS_AUDIT_ID
        WHERE FA.IS_ACTIVE = 1 AND AE.IS_ACTIVE = 1
      AND FA.AUDIT_CHECK_DEP_ID = :P_DEPARTMENT_ID`;
