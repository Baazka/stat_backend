  ...
  async BM4List(req, res) {
    try {
      ...
      INNER JOIN (
        ...
        LEFT JOIN FAS_ADMIN.AKT_EXECUTION_LIST EL ON C.ID = EL.SEVEN_ONE_ID AND EL.IS_ACTIVE = 1 AND EL.PERIOD_TYPE = 1 AND EL.ID = (SELECT MAX(ID) FROM FAS_ADMIN.AKT_EXECUTION_LIST WHERE SEVEN_ONE_ID = C.ID)
