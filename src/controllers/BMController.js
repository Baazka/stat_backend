    ...
    try {
      ...
      SELECT 
        ...
        INNER JOIN (
          ...
          NULL IS_SUB_ERROR_CONFLICT, NULL IS_SUB_ERROR_CONFLICT_NAME,
          A.UR_UGUUJ, V8.IND_VALUE_NAME UR_UGUUJ_NAME,
          NVL(E1.UR_UGUUJ_TYPE, E.UR_UGUUJ_TYPE) UR_UGUUJ_TYPE, 
          NVL(V2.IND_VALUE_NAME, V9.IND_VALUE_NAME) UR_UGUUJ_TYPE_NAME
          FROM FAS_ADMIN.FAS_DOC_5_1_CLAUSE A
          ...
          LEFT JOIN FAS_ADMIN.REF_DOCUMENT_INDICATOR_VALUE V8 ON A.UR_UGUUJ = V8.ID
          LEFT JOIN FAS_ADMIN.REF_DOCUMENT_INDICATOR_VALUE V9 ON E.UR_UGUUJ_TYPE = V9.ID
          LEFT JOIN FAS_ADMIN.REF_DOCUMENT_INDICATOR_VALUE V2 ON E1.UR_UGUUJ_TYPE = V2.ID
  ...
  async BM4List(req, res) {
    try {
      ...
      INNER JOIN (
        ...
        C.COMPLETION_DATE,
        SU.USER_ID, SU.USER_NAME AUDITOR_NAME, SU.USER_CODE AUDITOR_CODE, M.MO_DATE, CASE WHEN M.AMOUNT <> EL.EXEC_AMOUNT THEN EL.EXEC_AMOUNT ELSE M.AMOUNT END MO_AMOUNT,
        C.ACCOUNT_TYPE, V4.IND_VALUE_NAME ACCOUNT_TYPE_NAME,
        SUBSTR(C.LASTNAME,1,1)||'.'||C.FIRSTNAME FULL_NAME,
        EL.EXEC_DATE, A.AMOUNT - CASE WHEN M.AMOUNT <> EL.EXEC_AMOUNT THEN EL.EXEC_AMOUNT ELSE M.AMOUNT END NEXT_AMOUNT, C.COMPLETION_DATE - EL.EXEC_DATE DATE_CNT
        FROM FAS_ADMIN.FAS_DOC_5_5_SAMPLE A
        INNER JOIN FAS_ADMIN.FAS_DOC_7_1 C ON A.ID = C.ID_5_5
        LEFT JOIN FAS_ADMIN.FAS_DOC_5_6_SAMPLE E ON A.ID = E.ID_5_5 AND E.IS_CLAUSE = 0
        LEFT JOIN FAS_ADMIN.REF_DOCUMENT_INDICATOR_VALUE V1 ON A.SOLUTION = V1.ID
