...
module.exports = {
  async BM1List(req, res) {
    try {
      ...
      LEFT JOIN (SELECT A.FAS_AUDIT_ID, SUM(CASE WHEN A.UR_UGUUJ_TYPE = 320 THEN A.AMOUNT END) SUO, COUNT(CASE WHEN A.UR_UGUUJ_TYPE = 320 THEN A.AMOUNT END) SUO_TOO FROM 
