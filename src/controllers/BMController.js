...
LEFT JOIN (SELECT SEVEN_ONE_ID, MAX(MO_DATE) MO_DATE, MAX(CREATED_BY) CREATED_BY FROM FAS_ADMIN.AKT_MONITORING
     WHERE IS_ACTIVE = 1 
     GROUP BY SEVEN_ONE_ID) M ON A.ID = M.SEVEN_ONE_ID 
